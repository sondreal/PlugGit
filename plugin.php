...
/*
Plugin Name: PlugGit
Plugin URI: https://github.com/sondreal/PlugGit
 ...
 *
 * @package PlugGit
 * @author Sondre Dyrnes @link https://www.nettfrihet.no
 * @since 1.3
 * @version 1.5
 */
...
function github_plugin_updater_test_init() {
	...
	if ( is_admin() ) { // note the use of is_admin() to double check that this is happening in the admin
		...
		$config = array(
			...
			'api_url' => 'https://api.github.com/repos/sondreal/PlugGit',
			'raw_url' => 'https://raw.github.com/sondreal/PlugGit/master',
			'github_url' => 'https://github.com/sondreal/PlugGit',
			'zip_url' => 'https://github.com/sondreal/PlugGit/archive/master.zip',
			'sslverify' => true,
			'requires' => '3.0',
			'tested' => '3.3',
			'readme' => 'README.md',
